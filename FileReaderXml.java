...
public class FileReaderXml extends Information{
    ...
    try {
        ...
        for (int i = 0; i < nodeList1.getLength(); i++) {
            ...
            System.out.println("Добавлен дракон под номером " + dragon.getId() + ", " + ColorText.Text(dragon.getName(), dragon.getColor()));
            bool = true;
